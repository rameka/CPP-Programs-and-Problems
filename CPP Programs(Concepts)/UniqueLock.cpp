/*
UniqueLock.cpp: Elobrates on condition variable, mutex and unique_lock using put and get thread.
...
//unique_lock is defined as local variables which will be remove once the funciton is done
